...
//
// Sends them to the extractor model (tier=extractor, policy=local-preferred,
// so Gemma 3 27B on the Mac when reachable, Haiku cloud otherwise). The
// model returns proposed memories as JSON; we filter/dedupe and write the
// survivors via bulkWriteMemories.
//
