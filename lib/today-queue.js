import { buildRationale, computeTaskScore } from "./scoring.js";
...
/** Build queue payload for daily_plans from chosen outcomes (slot/type/task_id/why). */
export function buildQueueFromChosen(chosen, mode) {
